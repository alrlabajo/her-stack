    ...
    experience: (
      <div className="space-y-1">
        <div className="flex flex-col md:flex-row md:justify-between">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white md:h-4">
        ...
        <ul className="space-y-1 text-gray-700 dark:text-gray-300">
          <li className="flex items-start text-xs">
            <span className="w-1.5 h-1.5 bg-black dark:bg-white rounded-sm mt-2 mr-3 flex-shrink-0"></span>
    ...
    awards: (
      <div className="md:space-y-1">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-xs">
          ...
          under the category of Technology, Innovation, and Society.
        </p>
      </div>
    ),
  };
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                {[
                  ...
                  <span
                    key={index}
                    className="px-2 py-1 sm:px-3 sm:py-1.5 dark:text-neutral-300 text-zinc-900 rounded-full text-[10px] font-medium border dark:border-neutral-300 border-zinc-900 transition-colors duration-200"
                  >
                    {skill}
                  </span>
                ))}
